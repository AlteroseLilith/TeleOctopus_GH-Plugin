...
namespace TeleOctopus_Brain_plugin
{
    public class Brain : GH_Component
    {
        ...
        /// </summary>
        public Brain()
          : base("Hippocampus", "Memory",
            "Here is where the TeleOctopus Brain begin to growth.",
            "TeleOctopus", "Brain")
        {
        }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("758a91ed-d4a4-4f25-ba37-0963a5f68a99");
    }
}